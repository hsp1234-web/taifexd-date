...
class FileParser:
    ...
    def parse_file(self, file_path: str, staging_dir: str, schemas_config: dict) -> dict:
        ...
        return self._parse_single_csv(file_path, staging_dir, schemas_config, original_filename)

    def _parse_single_csv(
        self, file_or_buffer, staging_dir: str, schemas_config: dict, display_name: str
    ) -> dict:
